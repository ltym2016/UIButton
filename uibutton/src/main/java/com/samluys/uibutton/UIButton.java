...
public class UIButton extends AppCompatButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mShapeMode = typedArray.getInt(R.styleable.UIButton_ui_shapeMode, 0);
        mSolidColor = typedArray.getColor(R.styleable.UIButton_ui_solidColor, 0xFFFFFFFF);
        mPressedColor = typedArray.getColor(R.styleable.UIButton_ui_pressedColor, 0xFFC3C3C3);
        mStrokeColor = typedArray.getColor(R.styleable.UIButton_ui_strokeColor, 0);
        mStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.UIButton_ui_strokeWidth, 0);
        mCornerRadius = typedArray.getDimensionPixelSize(R.styleable.UIButton_ui_cornerRadius, 0);
        mCornerPosition = typedArray.getInt(R.styleable.UIButton_ui_cornerPosition, -1);
        mActiveEnable = typedArray.getBoolean(R.styleable.UIButton_ui_activeEnable, false);
        mStartColor = typedArray.getColor(R.styleable.UIButton_ui_startColor, 0xFFFFFFFF);
        mEndColor = typedArray.getColor(R.styleable.UIButton_ui_endColor, 0xFFFFFFFF);
        mOrientation = typedArray.getColor(R.styleable.UIButton_ui_orientation, 0);
        mCenterColor = typedArray.getColor(R.styleable.UIButton_ui_centerColor, 0xFFFFFFFF);
